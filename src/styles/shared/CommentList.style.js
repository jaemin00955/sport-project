...
///// Media Detail Comment 부분 시작 //////
export const MediaDetailComment = styled.div`
  position:${props=>props.position>140? "absolute;":"fixed;"}
  left:76vw;
  top:${props=>props.position>140?"65vh;":"25vh;"}
  width:23%;
  height:70vh;
  border:1px solid;
`
